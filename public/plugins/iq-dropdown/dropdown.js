  ...
  if (!window.dropdownInitialized) {
    ...
    $.fn.iqDropdown = function (options) {
      this.each(function () {
        ...
        function addControls(id, $item) {
          ...
          var $counter = $(`<span>${itemCount[id]}</span>`).addClass(
    ...
    $('.custom').iqDropdown({
      ...
      setSelectionText: (itemCount, totalItems, textPlural, selectionText) => {
        ...
        if (
          (itemCount.adult + itemCount.child) % 10 == 1 &&
          itemCount.adult + itemCount.child != 11
        ) {
          ...
          ((itemCount.adult + itemCount.child) % 10 == 2 ||
            (itemCount.adult + itemCount.child) % 10 == 3 ||
            (itemCount.adult + itemCount.child) % 10 == 4) &&
          itemCount.adult + itemCount.child != 11 &&
          itemCount.adult + itemCount.child != 12 &&
          itemCount.adult + itemCount.child != 13 &&
          itemCount.adult + itemCount.child != 14
        ) {
          ...
          itemCount.adult + itemCount.child > 4 ||
          itemCount.adult + itemCount.child == 11 ||
          itemCount.adult + itemCount.child == 12 ||
          itemCount.adult + itemCount.child == 11
        ) {
        ...
        if (itemCount.infant % 10 == 1 && itemCount.infant != 11) {
          ...
          (itemCount.infant % 10 == 2 ||
            itemCount.infant % 10 == 3 ||
            itemCount.infant % 10 == 4) &&
          itemCount.infant != 11 &&
          itemCount.infant != 12 &&
          itemCount.infant != 13 &&
          itemCount.infant != 14
    ...
    $('.custom-message').iqDropdown({
      ...
      setSelectionText: (
        ...
        if (itemCount.bedroom % 10 == 1 && itemCount.bedroom != 11) {
          ...
          (itemCount.bedroom % 10 == 2 ||
            itemCount.bedroom % 10 == 3 ||
            itemCount.bedroom % 10 == 4) &&
          itemCount.bedroom != 11 &&
          itemCount.bedroom != 12 &&
          itemCount.bedroom != 13 &&
          itemCount.bedroom != 14 &&
          itemCount.bedroom > 0
        ) {
        ...
        if (itemCount.bathroom % 10 == 1 && itemCount.bathroom != 11) {
          ...
          (itemCount.bathroom % 10 == 2 ||
            itemCount.bathroom % 10 == 3 ||
            itemCount.bathroom % 10 == 4) &&
          itemCount.bathroom != 11 &&
          itemCount.bathroom != 12 &&
          itemCount.bathroom != 13 &&
          itemCount.bathroom != 14 &&
          itemCount.bathroom > 0
        ) {
          z = itemCount.bathroom + ' ' + 'ванные комнаты';
        } else if (
          itemCount.bathroom > 4 ||
          itemCount.bathroom == 11 ||
          itemCount.bathroom == 12 ||
          itemCount.bathroom == 11
        ) {
